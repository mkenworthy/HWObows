...
ax.text(xyz[index_an,0]+2*di,xyz[index_an,1]+0.4, di/4, '$90^\circ-i$', None, fontsize=20, va='center', ha='center')
...
ax.text2D(0.08,0.2, '$i$', transform=ax.transAxes, fontsize=18, fontweight='bold')
...
### inc 1: mask 1 ###
ax = setup_plot(fig, 4)
ax.plot3D([0],[0],[0], 'ko', label='Mask', markersize=45, alpha=0.3)
ax.view_init(elev=0, azim=0)

### inc 1: mask 2 ###
ax = setup_plot(fig, 5)
ax.plot3D([0],[0],[0], 'ko', label='Mask', markersize=65, alpha=0.3)
...
### inc 1: mask 3 ###
ax = setup_plot(fig, 6)
ax.plot3D([0],[0],[0], 'ko', label='Mask', markersize=100, alpha=0.3)
ax.view_init(elev=0, azim=0)
...
iaxes = inset_axes(ax,width=1,height=3,bbox_transform=ax.transAxes,bbox_to_anchor=(-0.1,0.5),loc=6)
...
ax.plot3D([0],[0],[0], 'ko', label='Mask', markersize=65, alpha=0.3)
ax.plot3D([xyz[500,0]], [xyz[500,1]], [xyz[500,2]], c='#5790fc', marker='o', markersize=10)
ax.plot3D([xyz[280,0]], [xyz[280,1]], [xyz[280,2]], c='#7a21dd', marker='o', markersize=10)
ax.plot3D([xyz[720,0]], [xyz[720,1]], [xyz[720,2]], c='#964a8b', marker='o', markersize=10)
ax.view_init(elev=-20, azim=0)
...
ax.plot3D([0],[0],[0], 'ko', label='Mask', markersize=65, alpha=0.3)
ax.plot3D([xyz[500,0]], [xyz[500,1]], [xyz[500,2]], c='#5790fc', marker='o', markersize=10)
ax.plot3D([xyz[290,0]], [xyz[290,1]], [xyz[290,2]], c='#7a21dd', marker='o', markersize=10)
ax.plot3D([xyz[710,0]], [xyz[710,1]], [xyz[710,2]], c='#964a8b', marker='o', markersize=10)
ax.view_init(elev=-40, azim=0)

iaxes = inset_axes(ax,width=3,height=1,bbox_transform=ax.transAxes,bbox_to_anchor=(0.5,-0.3),loc=8)
