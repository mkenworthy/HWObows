"""
This is the original, non-parallelized version of the data generation script
`create-data-for-eccentric-orbits.py`. It is kept here for reference.

[I double-checked the MD5 hash of the output files generated by this
script against the output files generated by the parallelized version
ensure that the results are identical.]
"""

from src.scripts.utils.phases import *
from src.scripts.utils.samplers import *
